                ...
                >
                    <div className={`rounded-3xl overflow-hidden shadow-2xl flex flex-col border anim-modal-in ${isDarkTheme ? 'bg-slate-900 border-slate-700' : 'bg-white border-slate-200'}`}>
                        <div className={`p-6 bg-gradient-to-br from-blue-500/5 to-indigo-500/5 border-b relative ${isDarkTheme ? 'border-slate-700' : 'border-slate-100'}`}>
                            ...
                            <h3 className={`text-center text-lg tracking-tight px-4 ${isDarkTheme ? 'text-slate-100' : 'font-black text-slate-800'}`}>Chia s? tài liệu</h3>
                        ...
                        <div className="p-8 space-y-6">
                            <div className="space-y-3">
                                <label className={`block text-[10px] font-black uppercase tracking-widest border-l-2 border-blue-500 pl-2 ${isDarkTheme ? 'text-slate-400' : 'text-slate-400'}`}>Ðu?ng d?n tài liệu</label>
                                    ...
                                    <button
                                        onClick={() => {
                                            if (sharingDoc?.previewUrl) {
                                                ...
                                                toast.success('Đã copy link chia s?!');
                                            }
                                        }}
