...
fix('components/ai/GlobalWorkspaceView.tsx', /toast\.loading\('đang chạy\.\.\.'\);[\r\n]+/g, "toast.loading('đang chạy...');\n");
...
fix('pages/Flows.tsx', /'Kịch bản đang chạy : '/g, "'Kịch bản đang chạy' : '");
fix('pages/Flows.tsx', /'Nếu xóa, hệ thống sẽ ngừng xử lý các email đang chạy : '/g, "'Nếu xóa, hệ thống sẽ ngừng xử lý các email đang chạy' : '");
