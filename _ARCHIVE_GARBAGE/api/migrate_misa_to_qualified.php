<?php
/**
 * Migration: Update MISA CRM Subscribers to Qualified Status
 * 
 * This script updates all existing subscribers imported from MISA CRM
 * from 'active' status to 'qualified' status, since they are actual
 * customers from the CRM system.
 */

require_once __DIR__ . '/db_connect.php';

echo "=== MIGRATION: MISA SUBSCRIBERS TO QUALIFIED STATUS ===\n\n";
...
try {
    ...
    if ($activeCount === 0) {
        echo "✓ No active MISA subscribers found. All are already qualified or have other statuses.\n";
        echo "\n=== MIGRATION COMPLETE (Nothing to update) ===\n";
        exit;
    }

    // Step 2: Update active MISA subscribers to qualified
    echo "Step 2: Updating $activeCount active MISA subscribers to qualified...\n";
    ...
    echo "✓ Updated $updatedCount subscribers from 'active' to 'qualified'\n\n";
    ...
    echo "✅ Status changed: 'active' → 'qualified'\n";
    echo "✅ These customers are now properly marked as qualified leads from your CRM\n";
    echo "\nNext sync from MISA will automatically use 'qualified' status for new imports.\n";
