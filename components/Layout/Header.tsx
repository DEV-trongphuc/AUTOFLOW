  ...
  return (
    <header className="flex items-center justify-between h-20 px-6 lg:px-10 bg-white dark:bg-slate-950/80/80 backdrop-blur-xl border-b border-slate-200 dark:border-slate-800 sticky top-0 z-40">
      <div className="flex items-center gap-4">
        <button
          onClick={onMenuClick}
          className="text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:text-slate-100 lg:hidden p-2 hover:bg-slate-50 dark:bg-slate-900 rounded-xl transition-all"
        >
        ...
        <div className="hidden md:flex items-center gap-4">
          <button
            onClick={handleBack}
            className="w-10 h-10 flex items-center justify-center bg-white dark:bg-slate-950/80 border border-slate-200 dark:border-slate-800 rounded-2xl shadow-sm hover:bg-slate-50 dark:bg-slate-900 text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:text-slate-100 transition-all hover:scale-110 active:scale-95 group"
            title={"Quay l\u1EA1i"}
          >
            <ChevronRight className="w-5 h-5 rotate-180 text-slate-600 dark:text-slate-300 transition-transform group-hover:-translate-x-0.5" />
          </button>
          ...
          >
            ...
            <div className="flex items-center gap-4">
              <span className="text-[11px] font-black text-slate-400 group-hover/search:text-slate-800 dark:text-slate-100 uppercase tracking-widest transition-colors flex items-center gap-2">
      ...
      <div className="flex items-center gap-5">
        ...
        <div className="relative group">
          ...
          <div className="absolute top-full right-0 pt-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 translate-y-2 group-hover:translate-y-0 z-[100]">
            <div className="bg-white dark:bg-slate-950/80/90 backdrop-blur-xl border border-slate-200 dark:border-slate-800/50 shadow-2xl rounded-3xl p-3 w-48 space-y-2">
              <a
                href="https://fb.com/turni0"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-3 w-full p-3 rounded-2xl text-xs font-bold text-slate-600 dark:text-slate-300 hover:text-rose-600 hover:bg-rose-50 transition-all group/item"
              >
                <div className="w-8 h-8 rounded-xl bg-slate-50 dark:bg-slate-900 flex items-center justify-center group-hover/item:bg-rose-100 transition-colors shadow-sm">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-3 w-full p-3 rounded-2xl text-xs font-bold text-slate-600 dark:text-slate-300 hover:text-blue-600 hover:bg-blue-50 transition-all group/item"
              >
                <div className="w-8 h-8 rounded-xl bg-slate-50 dark:bg-slate-900 flex items-center justify-center group-hover/item:bg-blue-100 transition-colors shadow-sm">
