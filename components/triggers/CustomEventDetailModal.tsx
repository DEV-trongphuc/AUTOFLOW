...
interface CustomEventDetailModalProps {
    event: CustomEvent | null;
    onClose: () => void;
}

const CustomEventDetailModal: React.FC<CustomEventDetailModalProps> = ({ event, onClose: _onClose }) => {
    ...
    const jsSnippet = `<!-- Thêm vào trang web của bạn -->
<script>
  ...
  -d '{
    ...
    return (
        <div className="fixed inset-0 z-[200] flex items-center justify-center">
            ...
            >
                {/* Header */}
                <div className="bg-gradient-to-r from-violet-500 to-indigo-600 p-6 text-white relative">
                    <button
                        onClick={onClose}
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-violet-100 text-sm mt-1">Sự kiện Tùy chỉnh</p>
                        </div>
                    </div>
                </div>
