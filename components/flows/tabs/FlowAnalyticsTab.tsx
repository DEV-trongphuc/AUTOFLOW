...
const FlowAnalyticsTab: React.FC<{ flow: Flow }> = memo(({ flow }) => {
    ...
    const BottleneckBadge = ({ type, value, tooltip }: { type: 'time' | 'drop', value: string, tooltip?: string }) => (
        <div
            title={tooltip}
            className={`absolute -top-3 -right-3 z-50 px-3 py-1.5 rounded-full shadow-lg border flex items-center gap-2 animate-pulse cursor-help ${type === 'time' ? 'bg-amber-500 border-amber-400 text-white' : 'bg-orange-500 border-orange-400 text-white'
                }`}
        >
                ...
                <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-6 md:gap-10 items-center">
                                ...
                                <div>
                                    ...
                                    <div className="flex items-center gap-2 mt-0.5 md:mt-1">
                                        ...
                                        <span className="text-[9px] md:text-[10px] font-bold text-slate-400 uppercase tracking-widest">
                                            Automation {currentFlow.status === 'active' ? 'đang chạy' : 'đã dừng'}
                                        </span>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="lg:col-span-7 flex flex-col gap-6">
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8">
                            ...
                            <div className="bg-white/5 p-3 rounded-xl border border-white/5 lg:bg-transparent lg:p-0 lg:border-0">
                                <p className="text-[8px] md:text-[9px] font-bold uppercase text-slate-500 tracking-widest mb-1.5 md:mb-2 text-center lg:text-left">Gửi lỗi</p>
                                <div className="flex items-center justify-center lg:justify-start gap-2">
                                    <div className="p-1 px-1.5 bg-white/5 rounded-lg border border-white/5 hidden md:block">
                            ...
                            <div className="bg-white/5 p-3 rounded-xl border border-white/5 lg:bg-transparent lg:p-0 lg:border-0">
                                <p className="text-[8px] md:text-[9px] font-bold uppercase text-slate-500 tracking-widest mb-1.5 md:mb-2 text-center lg:text-left">Hủy ĐK</p>
                                <div className="flex items-center justify-center lg:justify-start gap-2">
                                    <div className="p-1 px-1.5 bg-white/5 rounded-lg border border-white/5 hidden md:block">
