                ...
                <>
                    ...
                    <Radio
                        ...
                        options={parentEmailStep?.type === 'zalo_zns' ? [
                            ...
                            { id: 'zns_failed', label: 'Gửi thất bại', icon: AlertTriangle, desc: 'Gửi lỗi (Hết quota, sai số...)' },
                        ] : [
                                ...
                                <>
                                    ...
                                    {!disabled && selectedLinks.length === availableLinks.length && (
                                        <div className="p-3 bg-amber-50 border border-amber-200 rounded-2xl flex items-start gap-3 animate-in fade-in zoom-in duration-300">
                                            ...
                                            <p className="text-[10px] text-amber-700 font-bold leading-relaxed lowercase first-letter:uppercase">Đang ở chế độ "Bất kỳ Link nào". Bỏ chọn một link bất kỳ nếu bạn chỉ muốn theo dõi danh sách cụ thể.</p>
                                        </div>
                                    )}
