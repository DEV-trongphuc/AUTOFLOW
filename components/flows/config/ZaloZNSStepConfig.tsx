    ...
    const allVariableGroups = [
        {
            ...
            vars: [
                ...
                { key: '{{full_name}}', label: 'H? và tên', desc: 'Full name' },
        ...
        },
        {
            ...
            vars: [
                ...
                { key: '{{current_date}}', label: 'Ngày hi?n t?i', desc: 'Current date dd/mm/yyyy' },
    ...
    if (oas.length === 0) {
        return (
            <div className="bg-amber-50 border border-amber-200 rounded-2xl p-6 text-center">
                ...
                <p className="text-sm font-bold text-amber-800 mb-2">Chua có Zalo OA</p>
                <p className="text-xs text-amber-600">Vui lòng thêm Zalo Official Account trong Settings tru?c.</p>
            </div>
        );
    }
                    ...
                    <div className="flex-1 space-y-2">
                        <div className="flex items-center justify-between">
                            <h4 className={`text-[11px] font-black uppercase tracking-widest ${isTimeInsecure ? 'text-orange-900' : 'text-emerald-900'}`}>
                                {isTimeInsecure ? 'C?nh báo khung gi? g?i ZNS' : 'Khung gi? Flow dã an toàn'}
                            </h4>
                        ...
                        <p className={`text-[11px] font-bold leading-relaxed ${isTimeInsecure ? 'text-orange-800' : 'text-emerald-800'}`}>
                            {isTimeInsecure
                                ? `Theo chính sách Zalo, tin ZNS ch? g?i du?c t? 06:00 - 22:00. Flow hi?n t?i (${flow.config.startTime} - ${flow.config.endTime}) có th? khi?n tin nh?n b? t?m gi? ho?c th?t b?i.`
                                : 'C?u hình th?i gian c?a Flow này dã tuân th? chính sách c?a Zalo (06:00 - 22:00). Tin nh?n ZNS s? du?c g?i di ngay l?p t?c.'
                            }
                        </p>
                    ...
                    {config.zalo_oa_id && (
                        <div className="relative z-20">
                            ...
                            <CustomSelect
                                ...
                                placeholder={templates.length === 0 ? "Không có template nào" : "-- Ch?n Template --"}
                            />
                                ...
                                <div className="mt-3 p-3 bg-amber-50 border border-amber-200 rounded-xl flex items-start gap-3 animate-in fade-in slide-in-from-top-2">
                                    ...
                                    <div>
                                        <p className="text-[11px] font-black text-amber-800 uppercase tracking-wide mb-1">
                                            Luu ý: Template không h? tr? UID
                                        </p>
                                        <p className="text-[11px] text-amber-700 leading-relaxed font-medium">
                                            M?u này s? <b>t? d?ng chuy?n sang g?i qua S? di?n tho?i</b> n?u b?n nh?p UID.
                                            <br />
                                            Chi phí d? ki?n: <b className="text-amber-900">{selectedTemplate.template_data?.price || 'theo quy d?nh Zalo'} VND/tin</b>.
                                        </p>
                                    </div>
                                </div>
                            )}
                                        ...
                                        <div className={`py-12 border-2 border-dashed rounded-[32px] flex flex-col items-center justify-center gap-4 transition-all ${csvFile ? 'border-emerald-200 bg-emerald-50/30' : 'border-slate-100 bg-slate-50/50 group-hover:border-blue-300 group-hover:bg-blue-50/30'}`}>
                                            ...
                                            <div className="text-center px-6">
                                                ...
                                                <p className="text-[10px] font-bold text-slate-400 mt-2 uppercase tracking-widest leading-relaxed">
                                                    {csvFile ? 'File dã s?n sàng x? lý' : 'Ch? ch?p nh?n file d?nh d?ng CSV có ch?a c?t SÐT'}
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <div className="bg-slate-50 rounded-2xl p-5 border border-slate-200 space-y-4">
                                                    ...
                                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                        ...
                                                        <div className="bg-emerald-50 border border-emerald-100 p-3 rounded-xl">
                                                            <div className="flex justify-between items-center mb-1">
                                                                <span className="text-[10px] font-bold text-emerald-600 uppercase">H?p l? (SÐT OK)</span>
                                                        ...
                                                        <div className="flex items-start gap-3 p-3 bg-rose-50 border border-rose-100 rounded-xl">
                                                            ...
                                                            <div>
                                                                ...
                                                                <p className="text-[11px] text-rose-600 leading-relaxed">
                                                                    File CSV thi?u các tham s? sau: <b>{csvStats.missingRequired.join(', ')}</b>.
                                                                    Tin nh?n có th? b? Zalo t? ch?i.
                                                                </p>
                                                            </div>
                                                        </div>
                                                    )}
                                                    ...
                                                    {(csvStats.totalRows - csvStats.validRows > 0) && (
                                                        <div className="flex items-start gap-3 p-3 bg-blue-50 border border-blue-100 rounded-xl">
                                                            ...
                                                            <div>
                                                                <p className="text-[11px] font-black text-blue-700 uppercase mb-1">X? lý hàng l?i</p>
                                                                <p className="text-[11px] text-blue-600 leading-relaxed">
                                                                    Có <b>{csvStats.totalRows - csvStats.validRows}</b> hàng ch?a SÐT không h?p l?.
                                                                    H? th?ng s? <span className="font-black px-1.5 py-0.5 bg-white rounded border border-blue-200">
                                                                        {config.fallback_behavior === 'mark_failed' ? 'C?T FLOW & BÁO L?I' : 'B? QUA & TI?P T?C'}
                                                                    </span> d?i v?i các liên h? này.
                                                                </p>
                                                            </div>
                                                        </div>
                                                    )}
                                ...
                                <div className="space-y-8">
                                                ...
                                                <div key={fieldName} className="space-y-2 group relative">
                                                    ...
                                                    <div className="flex justify-between items-center px-1">
                                                        <span className="text-[9px] font-medium text-slate-400 italic">
                                                            {param.require ? '* B?t bu?c nh?p' : 'Không b?t bu?c'}
                                                        </span>
                                                        {param.maxLength && (
                                                            <span className="text-[9px] font-black text-slate-300 uppercase">T?i da {param.maxLength} ký t?</span>
                                                        )}
                                                    </div>
                                                </div>
                                            );
                                    ...
                                    {templateParams.length === 0 && (
                                        <div className="text-center py-10 opacity-30">
                                            ...
                                            <p className="text-xs font-black uppercase tracking-widest">Không có tham s?</p>
                                        </div>
                                    )}
                                </div>
                            )}
                    ...
                    <div className="space-y-6">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <label className={`flex flex-col items-center gap-2 p-3 rounded-[24px] border-2 cursor-pointer transition-all hover:shadow-xl ${config.fallback_behavior === 'mark_failed' ? 'bg-rose-600 border-rose-600 text-white shadow-rose-200' : 'bg-white border-slate-100 text-slate-500 hover:border-rose-200'}`}>
                                    ...
                                    <div className="text-center">
                                        ...
                                        <p className={`text-[8px] font-bold ${config.fallback_behavior === 'mark_failed' ? 'text-rose-200' : 'text-slate-400'}`}>ÐÁNH D?U L?I</p>
                                    </div>
                                </label>
                            </div>
                        </div>
                        ...
                        <div className="bg-indigo-50/50 border border-indigo-100 rounded-[32px] p-6 flex flex-col sm:flex-row items-start gap-4">
                            ...
                            <div className="space-y-2 flex-1 min-w-0">
                                <p className="text-[11px] font-black text-slate-700 uppercase tracking-widest">Mách nh? cho b?n</p>
                                <ul className="space-y-3 text-[11px] text-slate-500 font-bold leading-relaxed">
                                    <li className="flex items-start gap-2.5">
                                        <div className="w-1.5 h-1.5 rounded-full bg-indigo-500 mt-1.5 shrink-0"></div>
                                        <p className="flex-1">Dùng <b className="text-indigo-600">Cá nhân hóa</b> khi mu?n g?i t? d?ng theo s? ki?n c?a khách.</p>
                                    </li>
                                    <li className="flex items-start gap-2.5">
                                        <div className="w-1.5 h-1.5 rounded-full bg-indigo-500 mt-1.5 shrink-0"></div>
                                        <p className="flex-1">Dùng <b className="text-indigo-600">CSV</b> khi dã có s?n danh sách SÐT trong file Excel/CSV.</p>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-[9px] font-bold text-slate-400 uppercase tracking-[0.2em]">Xác nh?n n?i dung s? hi?n th? trên di?n tho?i</p>
                                </div>
                            </div>
                            {previewUrl && (
                        ...
                        <div className="bg-slate-50/50 rounded-[48px] p-12 border border-slate-100 relative overflow-hidden flex flex-col items-center group">
                            ...
                            {loadingDetail ? (
                                <div className="h-[600px] flex flex-col items-center justify-center text-slate-400 gap-4">
                                    ...
                                    <p className="text-xs font-black uppercase tracking-[0.2em] animate-pulse">Ðang n?p b? xem tru?c...</p>
                                </div>
                            ) : previewUrl ? (
                                ...
                                <div className="h-[500px] flex flex-col items-center justify-center text-center max-w-sm mx-auto relative z-10">
                                    ...
                                    <h5 className="text-lg font-black text-slate-800 tracking-tight mb-2">KHÔNG TÌM TH?Y PREVIEW</h5>
                                    <p className="text-sm font-bold text-slate-400 leading-relaxed mb-8 uppercase tracking-wide px-4">
                                        Zalo chua cung c?p b?n xem tru?c cho Template này ho?c b? nh? d?m dang g?p l?i.
                                    </p>
                                    <button
