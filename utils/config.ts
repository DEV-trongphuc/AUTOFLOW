...
export const API_BASE_URL = (isLocal || (typeof window !== 'undefined' && window.location.hostname === 'open.domation.net')
    ? '/mail_api' 
    : ((import.meta as any).env.VITE_API_URL || 'https://automation.ideas.edu.vn/mail_api'));
